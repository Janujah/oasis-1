                                ...
                                <div class="card-body p-5 text-center" id='login-form'>
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        <div data-mdb-input-init class="form-outline form-white mb-4">
                                            ...
                                            <input type="email" id="typeEmailX" class="form-control form-control-lg" placeholder='........' />
                                            <label class="form-label" for="typeEmailX">Confirm Password</label>
                                            <input type="email" id="typeEmailX" class="form-control form-control-lg" placeholder='........' />
                                        </div>
                                        <a href='/ok'><button data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5" id='login-btn' type="submit" style={{ backgroundColor: '#110942' }}>Reset</button></a>
