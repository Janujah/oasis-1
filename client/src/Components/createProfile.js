...
// // // //         fetch('https://oasis-r62g.onrender.com/Doctors/create', {
// // // //             method: 'POST',
...
// // //         setLoading(true);
// // //         try {
// // //             const response = await fetch("https://oasis-r62g.onrender.com/Image/uploadImage", {
// // //                 method: "POST",
// // //                 headers: { "Content-Type": "application/json" },
...
// // //         setLoading(true);
// // //         try {
// // //             const response = await fetch("https://oasis-r62g.onrender.com/Image//uploadMultipleImages", {
// // //                 method: "POST",
// // //                 headers: { "Content-Type": "application/json" },
...
//     //         };
//     //         const response = await fetch('https://oasis-r62g.onrender.com/Doctors/create', {
//     //             method: 'POST',
//     //             headers: { 'Content-Type': 'application/json' },
...
// //         };
// //         await fetch('https://oasis-r62g.onrender.com/appointments', {
// //           method: 'POST',
// //           headers: { 'Content-Type': 'application/json' },
...
// //         await fetch('https://oasis-r62g.onrender.com/Email/payment-success', {
// //           method: 'POST',
// //           headers: { 'Content-Type': 'application/json' },
